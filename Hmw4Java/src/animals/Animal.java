...
/**
 * Class Animal main class for the animals
 * @author Abdalla Wattawda
 *
 */
public abstract class Animal extends Observable implements Cloneable,ColoredAnimal, IEdible, IDrawable, IAnimalBehavior, Runnable
{
	...
	/**
	 * set location function for the new location
	 * @param newLocation
	 * @return true
	 */
	...
	/**
	 * init function to initiate the params
	 * @param nm
	 * @param sz
	 * @param w
	 * @param hor
	...
	/**
	 * loadImage func to load the image using switch case and colors 
	 * @param nm
	 */
    ...
    /**
     * clone function for the design pattern prototype duplicate
     */
    public Object clone() {
        Object clone = null;
        try {
    ...
    /**
     * toString function to show info on the animal
     */
